import { a as getFunctionAddress, c as version, d as convexToJson, f as jsonToConvex, i as makeFunctionReference, l as ConvexError, m as parseArgs, n as filterApi, o as setReferencePath, p as patchValueToJson, r as getFunctionName, s as toReferencePath, t as anyApi, u as convexOrUndefinedToJson } from "./api-DYwC5UvS.js";
//#region node_modules/convex/dist/esm/values/validators.js
...
var BaseValidator = class {
	constructor({ isOptional }) {
		...
		* by this validator.
		*/
		__publicField$13(this, "type");
		/**
		* Only for TypeScript, if this an Object validator, then
		* this is the TS type of its property names.
		*/
		__publicField$13(this, "fieldPaths");
		/**
		* Whether this is an optional Object property value validator.
		*/
		__publicField$13(this, "isOptional");
		/**
		* Always `"true"`.
		*/
		__publicField$13(this, "isConvexValidator");
		this.isOptional = isOptional;
		this.isConvexValidator = true;
	}
};
var VId = class VId extends BaseValidator {
	/**
	...
	*/
	constructor({ isOptional, tableName }) {
		...
		*/
		__publicField$13(this, "tableName");
		/**
		* The kind of validator, `"id"`.
		*/
		__publicField$13(this, "kind", "id");
...
var VFloat64 = class VFloat64 extends BaseValidator {
	constructor() {
		super(...arguments);
		/**
		* The kind of validator, `"float64"`.
		*/
		__publicField$13(this, "kind", "float64");
	}
	/** @internal */
	get json() {
		return { type: "number" };
...
var VInt64 = class VInt64 extends BaseValidator {
	constructor() {
		super(...arguments);
		/**
		* The kind of validator, `"int64"`.
		*/
		__publicField$13(this, "kind", "int64");
	}
	/** @internal */
	get json() {
		return { type: "bigint" };
...
var VBoolean = class VBoolean extends BaseValidator {
	constructor() {
		super(...arguments);
		/**
		* The kind of validator, `"boolean"`.
		*/
		__publicField$13(this, "kind", "boolean");
	}
	/** @internal */
	get json() {
...
var VBytes = class VBytes extends BaseValidator {
	constructor() {
		super(...arguments);
		/**
		* The kind of validator, `"bytes"`.
		*/
		__publicField$13(this, "kind", "bytes");
	}
	/** @internal */
	get json() {
		return { type: this.kind };
...
var VString = class VString extends BaseValidator {
	constructor() {
		super(...arguments);
		/**
		* The kind of validator, `"string"`.
		*/
		__publicField$13(this, "kind", "string");
	}
	/** @internal */
	get json() {
		return { type: this.kind };
...
var VNull = class VNull extends BaseValidator {
	constructor() {
		super(...arguments);
		/**
		* The kind of validator, `"null"`.
		*/
		__publicField$13(this, "kind", "null");
	}
	/** @internal */
	get json() {
		return { type: this.kind };
...
var VAny = class VAny extends BaseValidator {
	constructor() {
		super(...arguments);
		/**
		* The kind of validator, `"any"`.
		*/
		__publicField$13(this, "kind", "any");
	}
	/** @internal */
	get json() {
		return { type: this.kind };
...
var VObject = class VObject extends BaseValidator {
	/**
	...
	*/
	constructor({ isOptional, fields }) {
		...
		*/
		__publicField$13(this, "fields");
		/**
		* The kind of validator, `"object"`.
		*/
		__publicField$13(this, "kind", "object");
	...
	get json() {
		return {
			type: this.kind,
			value: globalThis.Object.fromEntries(globalThis.Object.entries(this.fields).map(([k, v]) => [k, {
				fieldType: v.json,
...
var VLiteral = class VLiteral extends BaseValidator {
	/**
	...
	*/
	constructor({ isOptional, value }) {
		...
		*/
		__publicField$13(this, "value");
		/**
		* The kind of validator, `"literal"`.
		*/
		__publicField$13(this, "kind", "literal");
...
var VArray = class VArray extends BaseValidator {
	/**
	...
	*/
	constructor({ isOptional, element }) {
		...
		*/
		__publicField$13(this, "element");
		/**
		* The kind of validator, `"array"`.
		*/
		__publicField$13(this, "kind", "array");
...
var VRecord = class VRecord extends BaseValidator {
	/**
	...
	*/
	constructor({ isOptional, key, value }) {
		...
		*/
		__publicField$13(this, "kind", "record");
...
var VUnion = class VUnion extends BaseValidator {
	/**
	...
	*/
	constructor({ isOptional, members }) {
		...
		*/
		__publicField$13(this, "members");
		/**
		* The kind of validator, `"union"`.
		*/
		__publicField$13(this, "kind", "union");
...
//#endregion
//#region node_modules/convex/dist/esm/values/validator.js
...
//#endregion
//#region node_modules/convex/dist/esm/server/impl/syscall.js
...
//#endregion
//#region node_modules/convex/dist/esm/server/impl/actions_impl.js
...
function setupActionCalls(requestId) {
	return {
		runQuery: async (query, args) => {
			return jsonToConvex(await performAsyncSyscall("1.0/actions/query", syscallArgs(requestId, query, args)));
		},
		runMutation: async (mutation, args) => {
			return jsonToConvex(await performAsyncSyscall("1.0/actions/mutation", syscallArgs(requestId, mutation, args)));
		},
		runAction: async (action, args) => {
			return jsonToConvex(await performAsyncSyscall("1.0/actions/action", syscallArgs(requestId, action, args)));
		}
	};
}
//#endregion
//#region node_modules/convex/dist/esm/server/vector_search.js
...
var FilterExpression = class {
	...
	*/
	constructor() {
		__publicField$12(this, "_isExpression");
		__publicField$12(this, "_value");
	}
};
//#endregion
//#region node_modules/convex/dist/esm/server/impl/validate.js
...
//#endregion
//#region node_modules/convex/dist/esm/server/impl/vector_search_impl.js
...
var VectorQueryImpl = class {
	constructor(requestId, indexName, query) {
		__publicField$11(this, "requestId");
		__publicField$11(this, "state");
		this.requestId = requestId;
		const filters = query.filter ? serializeExpression$1(query.filter(filterBuilderImpl$1)) : null;
		this.state = {
			type: "preparing",
			query: {
				indexName,
...
var ExpressionImpl$1 = class extends FilterExpression {
	constructor(inner) {
		super();
		__publicField$11(this, "inner");
		this.inner = inner;
	}
	serialize() {
		return this.inner;
...
function serializeExpression$1(expr) {
	if (expr instanceof ExpressionImpl$1) return expr.serialize();
	else return { $literal: convexOrUndefinedToJson(expr) };
}
var filterBuilderImpl$1 = {
	eq(fieldName, value) {
		if (typeof fieldName !== "string") throw new Error("The first argument to `q.eq` must be a field name.");
		return new ExpressionImpl$1({ $eq: [serializeExpression$1(new ExpressionImpl$1({ $field: fieldName })), serializeExpression$1(value)] });
	},
	or(...exprs) {
		return new ExpressionImpl$1({ $or: exprs.map(serializeExpression$1) });
	}
};
//#endregion
//#region node_modules/convex/dist/esm/server/impl/authentication_impl.js
function setupAuth(requestId) {
	return { getUserIdentity: async () => {
		return await performAsyncSyscall("1.0/getUserIdentity", { requestId });
	} };
}
//#endregion
//#region node_modules/convex/dist/esm/server/filter_builder.js
...
var Expression = class {
	...
	*/
	constructor() {
		__publicField$10(this, "_isExpression");
		__publicField$10(this, "_value");
	}
};
//#endregion
//#region node_modules/convex/dist/esm/server/impl/filter_builder_impl.js
...
var filterBuilderImpl = {
	eq(l, r) {
		return new ExpressionImpl({ $eq: [serializeExpression(l), serializeExpression(r)] });
	},
	neq(l, r) {
		return new ExpressionImpl({ $neq: [serializeExpression(l), serializeExpression(r)] });
	},
	lt(l, r) {
		return new ExpressionImpl({ $lt: [serializeExpression(l), serializeExpression(r)] });
	},
	lte(l, r) {
		return new ExpressionImpl({ $lte: [serializeExpression(l), serializeExpression(r)] });
	},
	gt(l, r) {
		return new ExpressionImpl({ $gt: [serializeExpression(l), serializeExpression(r)] });
	},
	gte(l, r) {
		return new ExpressionImpl({ $gte: [serializeExpression(l), serializeExpression(r)] });
	},
	add(l, r) {
		return new ExpressionImpl({ $add: [serializeExpression(l), serializeExpression(r)] });
	},
	sub(l, r) {
		return new ExpressionImpl({ $sub: [serializeExpression(l), serializeExpression(r)] });
	},
	mul(l, r) {
		return new ExpressionImpl({ $mul: [serializeExpression(l), serializeExpression(r)] });
	},
	div(l, r) {
		return new ExpressionImpl({ $div: [serializeExpression(l), serializeExpression(r)] });
	},
	mod(l, r) {
		return new ExpressionImpl({ $mod: [serializeExpression(l), serializeExpression(r)] });
	},
	neg(x) {
...
//#endregion
//#region node_modules/convex/dist/esm/server/index_range_builder.js
...
var IndexRange = class {
	...
	*/
	constructor() {
		__publicField$8(this, "_isIndexRange");
	}
};
//#endregion
//#region node_modules/convex/dist/esm/server/impl/index_range_builder_impl.js
...
var IndexRangeBuilderImpl = class IndexRangeBuilderImpl extends IndexRange {
	constructor(rangeExpressions) {
		super();
		__publicField$7(this, "rangeExpressions");
		__publicField$7(this, "isConsumed");
...
//#endregion
//#region node_modules/convex/dist/esm/server/search_filter_builder.js
...
var SearchFilter = class {
	...
	*/
	constructor() {
		__publicField$6(this, "_isSearchFilter");
	}
};
//#endregion
//#region node_modules/convex/dist/esm/server/impl/search_filter_builder_impl.js
...
var SearchFilterBuilderImpl = class SearchFilterBuilderImpl extends SearchFilter {
	constructor(filters) {
		super();
		__publicField$5(this, "filters");
		__publicField$5(this, "isConsumed");
	...
	eq(fieldName, value) {
		...
		if (arguments.length !== 2) validateArg(value, 2, "search", "value");
		this.consume();
		return new SearchFilterBuilderImpl(this.filters.concat({
			type: "Eq",
			fieldPath: fieldName,
...
//#endregion
//#region node_modules/convex/dist/esm/server/impl/query_impl.js
...
var QueryInitializerImpl = class {
	constructor(tableName) {
		__publicField$4(this, "tableName");
		this.tableName = tableName;
	}
	...
	async count() {
		return jsonToConvex(await performAsyncSyscall("1.0/count", { table: this.tableName }));
	}
	filter(predicate) {
...
var QueryImpl = class QueryImpl {
	constructor(query) {
		...
		__publicField$4(this, "tableNameForErrorMessages");
		this.state = {
			type: "preparing",
			query
		};
	...
	startQuery() {
		...
		const query = this.state.query;
		const { queryId } = performSyscall("1.0/queryStream", {
			query,
			version
		});
		this.state = {
	...
	filter(predicate) {
		...
		query.operators.push({ filter: serializeExpression(predicate(filterBuilderImpl)) });
		return new QueryImpl(query);
	}
	limit(n) {
	...
	async next() {
		if (this.state.type === "closed" || this.state.type === "consumed") throwClosedError(this.state.type);
		const { value, done } = await performAsyncSyscall("1.0/queryStreamNext", { queryId: this.state.type === "preparing" ? this.startQuery() : this.state.queryId });
		if (done) this.closeQuery();
		return {
			value: jsonToConvex(value),
			done
		};
	}
	return() {
	...
	async paginate(paginationOpts) {
		...
		const { page, isDone, continueCursor, splitCursor, pageStatus } = await performAsyncSyscall("1.0/queryPage", {
			query,
			cursor,
			endCursor: paginationOpts?.endCursor ?? null,
			pageSize,
			maximumRowsRead: paginationOpts.maximumRowsRead ?? null,
...
//#endregion
//#region node_modules/convex/dist/esm/server/impl/database_impl.js
async function get(table, id, isSystem) {
	...
	return jsonToConvex(await performAsyncSyscall("1.0/get", {
		id: convexToJson(id),
		isSystem,
		version,
		table
	...
	const reader = (isSystem = false) => {
		return {
			...
			normalizeId: (tableName, id) => {
				...
				return jsonToConvex(performSyscall("1.0/db/normalizeId", {
					table: tableName,
					idString: id
				})).id;
			},
...
async function insert(tableName, value) {
	...
	return jsonToConvex(await performAsyncSyscall("1.0/insert", {
		table: tableName,
...
//#endregion
//#region node_modules/convex/dist/esm/server/impl/scheduler_impl.js
function setupMutationScheduler() {
	return {
		runAfter: async (delayMs, functionReference, args) => {
			return await performAsyncSyscall("1.0/schedule", runAfterSyscallArgs(delayMs, functionReference, args));
		},
		runAt: async (ms_since_epoch_or_date, functionReference, args) => {
			return await performAsyncSyscall("1.0/schedule", runAtSyscallArgs(ms_since_epoch_or_date, functionReference, args));
		},
		cancel: async (id) => {
			validateArg(id, 1, "cancel", "id");
			await performAsyncSyscall("1.0/cancel_job", { id: convexToJson(id) });
		}
	};
}
function setupActionScheduler(requestId) {
	return {
		...
		cancel: async (id) => {
			validateArg(id, 1, "cancel", "id");
			return await performAsyncSyscall("1.0/actions/cancel_job", {
				requestId,
				id: convexToJson(id)
			});
		}
...
//#endregion
//#region node_modules/convex/dist/esm/server/impl/storage_impl.js
...
//#endregion
//#region node_modules/convex/dist/esm/server/impl/meta_impl.js
async function getTransactionMetrics() {
	let syscallJSON;
	try {
		syscallJSON = await performAsyncSyscall("1.0/getTransactionMetrics", {});
	} catch (e) {
		if (e.message?.includes("Unknown async operation")) throw new Error("getTransactionMetrics() can only be called from a query or mutation. It is not available in actions or outside of a Convex function.");
		throw e;
	}
	return jsonToConvex(syscallJSON);
}
async function getFunctionMetadata() {
	const { name, componentPath } = await performAsyncSyscall("1.0/getFunctionMetadata", {});
	return {
		name,
		componentPath
	};
...
function setupActionMeta(visibility) {
	return { getFunctionMetadata: async () => ({
		...await getFunctionMetadata(),
		type: "action",
		visibility
	}) };
...
//#endregion
//#region node_modules/convex/dist/esm/server/impl/registration_impl.js
async function invokeMutation(func, argsStr, visibility) {
	const requestId = "";
	const args = jsonToConvex(JSON.parse(argsStr));
	const result = await invokeFunction(func, {
		db: setupWriter(),
...
function validateReturnValue(v2) {
	if (v2 instanceof QueryInitializerImpl || v2 instanceof QueryImpl) throw new Error("Return value is a Query. Results must be retrieved with `.collect()`, `.take(n), `.unique()`, or `.first()`.");
}
...
function serializeConvexErrorData(thrown) {
	if (typeof thrown === "object" && thrown !== null && Symbol.for("ConvexError") in thrown) {
		const error = thrown;
		error.data = JSON.stringify(convexToJson(error.data === void 0 ? null : error.data));
...
function assertNotBrowser() {
	...
	if (Object.getOwnPropertyDescriptor(globalThis, "window")?.get?.toString().includes("[native code]") ?? false) console.error("Convex functions should not be imported in the browser. This will throw an error in future versions of `convex`. If this is a false negative, please report it to Convex support.");
}
...
function exportArgs(functionDefinition) {
	return () => {
		let args = v.any();
		if (typeof functionDefinition === "object" && functionDefinition.args !== void 0) args = asObjectValidator(functionDefinition.args);
...
function exportReturns(functionDefinition) {
	return () => {
		let returns;
		if (typeof functionDefinition === "object" && functionDefinition.returns !== void 0) returns = asObjectValidator(functionDefinition.returns);
...
async function invokeHttpAction(func, request) {
	const requestId = "";
	return await invokeFunction(func, {
		...setupActionCalls(requestId),
		auth: setupAuth(requestId),
		storage: setupStorageActionWriter(requestId),
		scheduler: setupActionScheduler(requestId),
...
async function runUdf(udfType, f, args) {
	return jsonToConvex(await performAsyncSyscall("1.0/runUdf", {
		udfType,
		args: convexToJson(parseArgs(args)),
...
//#endregion
//#region node_modules/convex/dist/esm/server/pagination.js
...
//#endregion
//#region node_modules/convex/dist/esm/server/cron.js
...
var Crons = class {
	constructor() {
		__publicField$3(this, "crons");
		__publicField$3(this, "isCrons");
		this.isCrons = true;
		this.crons = {};
	}
	/** @internal */
	...
	*/
	interval(cronIdentifier, schedule, functionReference, ...args) {
		...
		if (hasSeconds + hasMinutes + hasHours !== 1) throw new Error("Must specify one of seconds, minutes, or hours");
...
//#endregion
//#region node_modules/convex/dist/esm/server/router.js
...
var HttpRouter = class {
	constructor() {
		__publicField$2(this, "exactRoutes", /* @__PURE__ */ new Map());
		__publicField$2(this, "prefixRoutes", /* @__PURE__ */ new Map());
		__publicField$2(this, "isRouter", true);
		/**
		...
		* ```
		*/
		__publicField$2(this, "route", (spec) => {
		...
		*/
		__publicField$2(this, "getRoutes", () => {
			const exact = [...this.exactRoutes.keys()].sort().flatMap((path) => [...this.exactRoutes.get(path).keys()].sort().map((method) => [
				path,
				method,
				this.exactRoutes.get(path).get(method)
			]));
			const prefixes = [...this.prefixRoutes.keys()].sort().flatMap((method) => [...this.prefixRoutes.get(method).keys()].sort().map((pathPrefix) => [
				`${pathPrefix}*`,
				method,
		...
		*/
		__publicField$2(this, "lookup", (path, method) => {
			...
			const prefixesSorted = [...(this.prefixRoutes.get(method) || /* @__PURE__ */ new Map()).entries()].sort(([prefixA, _a], [prefixB, _b]) => prefixB.length - prefixA.length);
			for (const [pathPrefix, endpoint] of prefixesSorted) if (path.startsWith(pathPrefix)) return [
				endpoint,
				method,
				`${pathPrefix}*`
			];
		...
		*/
		__publicField$2(this, "runRequest", async (argsStr, requestRoute) => {
			const request = performJsSyscall("requestFromConvexJson", { convexJson: JSON.parse(argsStr) });
			...
			if (!match) {
				const response2 = new Response(`No HttpAction routed for ${pathname}`, { status: 404 });
				return JSON.stringify(performJsSyscall("convexJsonFromResponse", { response: response2 }));
			}
			const [endpoint, _method, _path] = match;
			const response = await endpoint.invokeHttpAction(request);
			return JSON.stringify(performJsSyscall("convexJsonFromResponse", { response }));
		});
	}
};
//#endregion
...
var InstalledComponent = class {
	constructor(definition, name) {
		...
		* @internal
		*/
		__publicField$1(this, "_definition");
		/**
		* @internal
		*/
...
function createExports(name, pathParts) {
	return new Proxy({}, { get(_, prop) {
		if (typeof prop === "string") return createExports(name, [...pathParts, prop]);
...
function use(definition, options) {
	...
	const name = options?.name ?? importedComponentDefinition.defaultName ?? importedComponentDefinition.componentDefinitionPath.split("/").pop();
	if (typeof name !== "string") throw new Error(`Component name must be a string. Received: ${typeof name}`);
	if (name.length === 0) throw new Error("Component name cannot be empty.");
	const httpPrefix = options?.httpPrefix;
	if (httpPrefix !== void 0) {
		if (!httpPrefix.startsWith("/")) throw new Error(`httpPrefix must start with "/". Received: "${httpPrefix}"`);
	}
...
function buildHttpMounts(childComponents) {
	const httpMounts = {};
	for (const [name, , , httpPrefix] of childComponents) if (httpPrefix !== void 0) {
...
function serializeChildComponents(childComponents) {
	return childComponents.map(([name, definition, p]) => {
		...
		if (p !== null) {
			args = [];
			for (const [name2, value] of Object.entries(p)) if (value !== void 0) args.push([name2, {
				type: "value",
...
function exportComponentForAnalysis() {
	const args = Object.entries(this._args).map(([name, validator]) => [name, {
		type: "value",
...
function defineApp(options) {
	const httpPrefix = options?.httpPrefix;
	if (httpPrefix !== void 0 && !httpPrefix.startsWith("/")) throw new Error(`httpPrefix must start with "/". Received: "${httpPrefix}"`);
	return {
		_isRoot: true,
		_childComponents: [],
		_exportTree: {},
...
function currentSystemUdfInComponent(componentId) {
	return { [toReferencePath]: `_reference/currentSystemUdfInComponent/${componentId}` };
}
...
//#endregion
//#region node_modules/convex/dist/esm/server/schema.js
...
function defineTable(documentSchema) {
	if (isValidator(documentSchema)) return new TableDefinition(documentSchema);
	else return new TableDefinition(v.object(documentSchema));
}
...
defineSchema({
	_scheduled_functions: defineTable({
		...
		state: v.union(v.object({ kind: v.literal("pending") }), v.object({ kind: v.literal("inProgress") }), v.object({ kind: v.literal("success") }), v.object({
