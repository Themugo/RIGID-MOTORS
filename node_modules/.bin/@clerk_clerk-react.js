...
//#region node_modules/@clerk/shared/dist/runtime/error-Dl9xmUf3.mjs
/**
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/constants-ByUssRbE.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/isomorphicAtob-DybBXGFR.mjs
/**
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/keys-YNv6yjKk.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/underscore-DjQrhefX.mjs
/**
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/telemetry-wqMDWlvR.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/noop-B3MbDAfb.mjs
var noop$3 = (..._args) => {};
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/createDeferredPromise-CjYZzUuU.mjs
/**
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/organization-BqxdOtRG.mjs
/**
...
var OBJECT$1 = Object;
var isUndefined$1 = (v) => v === UNDEFINED$2;
...
var initCache = (provider, options) => {
	if (!SWRGlobalState.has(provider)) {
		...
		const mutate = internalMutate.bind(UNDEFINED$2, provider);
		let unmount = noop$2;
		...
		const initProvider = () => {
			if (!SWRGlobalState.has(provider)) {
				...
				if (!IS_SERVER) {
					const releaseFocus = opts.initFocus(setTimeout.bind(UNDEFINED$2, revalidateAllKeys.bind(UNDEFINED$2, EVENT_REVALIDATORS, 0)));
					const releaseReconnect = opts.initReconnect(setTimeout.bind(UNDEFINED$2, revalidateAllKeys.bind(UNDEFINED$2, EVENT_REVALIDATORS, 1)));
					unmount = () => {
...
var SWRConfig$1 = (props) => {
	...
	const cacheContextRef = (0, import_react.useRef)(UNDEFINED$2);
...
var useSWRHandler = (_key, fetcher, config) => {
	...
	const fallback = isUndefined$1(fallbackData) ? isUndefined$1(config.fallback) ? UNDEFINED$2 : config.fallback[key] : fallbackData;
...
//#endregion
//#region node_modules/swr/dist/mutation/index.mjs
...
var mutation = () => (key, fetcher, config = {}) => {
	...
	const trigger = (0, import_react.useCallback)(async (arg, opts) => {
		const [serializedKey, resolvedKey] = serialize$1(keyRef.current);
...
var useCheckout = (options) => {
	...
	const manager = (0, import_react.useMemo)(() => clerk.__experimental_checkout({
		planId,
		planPeriod,
		for: forOrganization
	}), [
	...
	const managerProperties = (0, import_react.useSyncExternalStore)((cb) => manager.subscribe(cb), () => manager.getState(), () => manager.getState());
	return { checkout: {
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/runtimeEnvironment-BB2sO-19.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/deprecated-BqlFbLHj.mjs
/**
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/handleValueOrFn-CcwnRX-K.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/utils-BfsP_p13.mjs
var logErrorInDevMode = (message) => {
	if (isDevelopmentEnvironment()) console.error(`Clerk: ${message}`);
};
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/object-Be3MMNTQ.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/retry-DAlTROH9.mjs
var defaultOptions = {
	initialDelay: 125,
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/loadScript-t1vaIfy5.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/proxy-Bq8EHApG.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/url-Cdy8w8vK.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/versionSelector-B1dLG0_G.mjs
/**
...
var versionSelector = (clerkJSVersion, packageVersion = "5.125.7") => {
	...
	if (prereleaseTag) {
		if (prereleaseTag === "snapshot") return "5.125.7";
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/loadClerkJsScript-BcmR4xsJ.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/deriveState-ChDqlleE.mjs
/**
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/browser-D5e8obql.mjs
/**
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/eventBus-UpdW-1JB.mjs
/**
* @internal
*/
...
setClerkJsLoadingErrorPackageName("@clerk/clerk-react");
//#endregion
export { APIKeys, AuthenticateWithRedirectCallback, ClerkDegraded, ClerkFailed, ClerkLoaded, ClerkLoading, ClerkProvider, CreateOrganization, GoogleOneTap, OrganizationList, OrganizationProfile, OrganizationSwitcher, PricingTable, Protect, RedirectToCreateOrganization, RedirectToOrganizationProfile, RedirectToSignIn, RedirectToSignUp, RedirectToTasks, RedirectToUserProfile, SignIn, SignInButton, SignInWithMetamaskButton, SignOutButton, SignUp, SignUpButton, SignedIn, SignedOut, TaskChooseOrganization, TaskResetPassword, TaskSetupMFA, UserAvatar, UserButton, UserProfile, Waitlist, __experimental_CheckoutProvider, PaymentElement as __experimental_PaymentElement, PaymentElementProvider as __experimental_PaymentElementProvider, useCheckout as __experimental_useCheckout, usePaymentElement as __experimental_usePaymentElement, useAuth, useClerk, useEmailLink, useOrganization, useOrganizationCreationDefaultsHook as useOrganizationCreationDefaults, useOrganizationList, useReverification, useSession, useSessionList, useSignIn, useSignUp, useUser };
