...
import { _ as toByteArray, c as version, d as convexToJson, f as jsonToConvex, g as fromByteArray, h as validateDeploymentUrl, i as makeFunctionReference, l as ConvexError, m as parseArgs, r as getFunctionName } from "./api-DYwC5UvS.js";
//#region node_modules/convex/dist/esm/values/compare_utf8.js
...
//#endregion
//#region node_modules/convex/dist/esm/values/compare.js
...
var DefaultLogger = class {
	constructor(options) {
		__publicField$11(this, "_onLogLineFuncs");
		__publicField$11(this, "_verbose");
...
var LocalSyncState = class {
	constructor() {
		__publicField$10(this, "nextQueryId");
		__publicField$10(this, "querySetVersion");
		__publicField$10(this, "querySet");
		__publicField$10(this, "queryIdToToken");
		__publicField$10(this, "identityVersion");
		__publicField$10(this, "auth");
		__publicField$10(this, "outstandingQueriesOlderThanRestart");
		__publicField$10(this, "outstandingAuthOlderThanRestart");
		__publicField$10(this, "paused");
		__publicField$10(this, "pendingQuerySetModifications");
		this.nextQueryId = 0;
...
function useConvexConnectionState() {
	const convex = (0, import_react.useContext)(ConvexContext);
	if (convex === void 0) throw new Error("Could not find Convex client! `useConvexConnectionState` must be used in the React component tree under `ConvexProvider`. Did you forget it? See https://docs.convex.dev/quick-start#set-up-convex-in-your-react-app");
	return useSubscription({
		getCurrentValue: (0, import_react.useCallback)(() => {
			return convex.connectionState();
		}, [convex]),
		subscribe: (0, import_react.useCallback)((callback) => {
...
function usePaginatedQueryInternal(query, args, options) {
	...
	const [results, maybeLastResult] = (0, import_react.useMemo)(() => {
		...
		for (const pageKey of currState.pageKeys) {
			...
			if (currResult.pageStatus === "SplitRequired") return [allItems, void 0];
...
//#endregion
//#region node_modules/convex/dist/esm/react/use_paginated_query2.js
...
function ConvexProviderWithAuth({ children, client, useAuth }) {
	...
	if (authProviderLoading && isConvexAuthenticated !== null) setIsConvexAuthenticated(null);
	if (!authProviderLoading && !authProviderAuthenticated && isConvexAuthenticated !== false) setIsConvexAuthenticated(false);
...
//#endregion
//#region node_modules/convex/dist/esm/react/auth_helpers.js
...
//#endregion
export { AuthLoading, Authenticated, ConvexProvider, ConvexProviderWithAuth, ConvexReactClient, Unauthenticated, includePage, insertAtBottomIfLoaded, insertAtPosition, insertAtTop, optimisticallyUpdateValueInPaginatedQuery, page, resetPaginationId, useAction, useConvex, useConvexAuth, useConvexConnectionState, useMutation, usePaginatedQuery, usePaginatedQueryInternal, usePaginatedQuery_experimental, usePreloadedQuery, useQueries, useQuery, useSubscription };
